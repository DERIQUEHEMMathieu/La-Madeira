<?php
/**
 * Blossom Travel Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Travel_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Travel_Repeater_Setting extends WP_Customize_Setting {
